...
import { editlecturerAPI } from '../../apis/lecturer';
...
const LecturerEditPage: React.FC = () => {
  const { id } = useParams();
  console.log('id', id);
  ...
  return (
    ...
    >
      ...
      >
        <Input placeholder={lecturer[0].username} />
      </Form.Item>
      ...
      >
        <Input placeholder={lecturer[0].firstName} />
      </Form.Item>
      ...
      >
        <Input placeholder={lecturer[0].lastName} />
      </Form.Item>
      <Form.Item
        name='phone'
        label='Phone Number'
      ...
      >
        <Input placeholder={lecturer[0].email} />
      </Form.Item>
      ...
      >
        <Input placeholder={lecturer[0].dateofbirth} />
      </Form.Item>
      ...
      >
        <Input placeholder={lecturer[0].address} />
      </Form.Item>
      ...
      >
        <Input placeholder={lecturer[0].degree} />
      </Form.Item>
